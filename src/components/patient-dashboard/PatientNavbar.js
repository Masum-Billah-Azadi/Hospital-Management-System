...
import { Bars3Icon, PowerIcon, HomeIcon, UserGroupIcon, CalendarDaysIcon, HeartIcon, UserCircleIcon } from "@heroicons/react/24/solid";
      ...
      <div className="relative mx-auto flex items-center justify-between">
        ...
        <Menu>
          ...
          <MenuList className="bg-light-card dark:bg-dark-card text-light-text-primary dark:text-dark-text-primary border-gray-300 dark:border-gray-700">
            ...
            <MenuItem onClick={() => router.push('/patient-dashboard/profile')} className="flex items-center gap-2">
