...
const navLinks = [
    ...
    { href: "/dashboard/appointments", label: "Appointments", icon: <CalendarDaysIcon className="h-5 w-5" /> },
    { href: "/dashboard/patients", label: "Patients", icon: <UserGroupIcon className="h-5 w-5" /> },
        ...
        <Card className="sticky top-4 h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 bg-light-card dark:bg-dark-card">
            <div className="flex flex-col h-full">
                ...
                <div className="mt-auto">
                    <ThemeSwitcher />
                    <ListItem onClick={() => signOut({ callbackUrl: '/login' })} className="text-red-500 hover:bg-red-500/10 focus:bg-red-500/10 active:bg-red-500/10">
